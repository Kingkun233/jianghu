...
<div class="loginBox">
	...
	<form action="<?php echo U('admin/dologin');?>" method="post">
			<ul class="login">
				<li class="l_tit">管理员帐号</li>
				<li class="mb_10"><input type="text"  name="name" placeholder="请输入管理员帐号"class="login_input user_icon"></li>
				...
				<img src="<?php echo U('admin/getVerify');?>" alt=""  onclick="this.src='<?php echo U('admin/getVerify');?>'+'?'+Math.random()"/>
...
<div class="hr_25"></div>
<div class="footer">
	<p><a href="#">江湖简介</a><i>|</i><a href="#">江湖公告</a><i>|</i> <a href="#">招纳贤士</a><i>|</i><a href="#">联系我们</a><i>|</i>客服热线：</p>
	<p>Copyright &copy; 2006 - 2014 江湖版权所有&nbsp;&nbsp;&nbsp;京ICP备09037834号&nbsp;&nbsp;&nbsp;京ICP证B1034-8373号&nbsp;&nbsp;&nbsp;某市公安局XX分局备案编号：123456789123</p>
