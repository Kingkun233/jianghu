...
<link rel="stylesheet" type="text/css" href="/jianghuadmin/Public/css/backstage.css" />
</head>

<body>
    <div class="head">
            
            <h3 class="head_text fl">抱团后台管理系统</h3>
    </div>
        ...
        <div class="menu">
            <div class="cont">
                ...
                <ul class="mList">
                    ...
                    <li>
                        <h3><span  onclick="show('menu3','change3')" id="change3" >+</span>邀请函管理</h3>
                        <dl id="menu3" style="display:none;">
                            <dd><a href="<?php echo U('introduce/index');?>" target="mainFrame">邀请函列表</a></dd>
                        </dl>
                    </li>
                    <li>
                        <h3><span onclick="show('menu4','change4')" id="change4">+</span>用户管理</h3>
                        <dl id="menu4" style="display:none;">
                        	<dd><a href="<?php echo U('user/add');?>" target="mainFrame">添加用户</a></dd>
